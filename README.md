...
A Relational Database is a group of items that have pre-defined relationships between them, organized with tables, columns and rows, whereas SQL is the language used to communicate with a database, .
